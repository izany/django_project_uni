...
def seed_groups(self):
    GROUPS = {
        'administrator': [
            ...
            ('auth', 'user', ['add', 'view', 'change', 'delete']),
            ('helpdesk', 'checklist', ['add', 'view', 'change', 'delete']),
            ('helpdesk', 'checklisttask', ['add', 'view', 'change', 'delete']),
            ('helpdesk', 'checklisttemplate', ['add', 'view', 'change', 'delete']),
            ('helpdesk', 'customfield', ['add', 'view', 'change', 'delete']),
            ('helpdesk', 'customfield', ['add', 'view', 'change', 'delete']),
            ('helpdesk', 'emailtemplate', ['add', 'view', 'change', 'delete']),
            ('helpdesk', 'escalationexclusion', ['add', 'view', 'change', 'delete']),
            ('helpdesk', 'followup', ['add', 'view', 'change', 'delete']),
            ('helpdesk', 'kbiattachment', ['add', 'view', 'change', 'delete']),
            ('helpdesk', 'followupattachment', ['add', 'view', 'change', 'delete']),
            ('helpdesk', 'ignoreemail', ['add', 'view', 'change', 'delete']),
            ('helpdesk', 'presetreply', ['add', 'view', 'change', 'delete']),
            ('helpdesk', 'queue', ['add', 'view', 'change', 'delete']),
            ('helpdesk', 'savedsearch', ['add', 'view', 'change', 'delete']),
            ('helpdesk', 'ticket', ['add', 'view', 'change', 'delete']),
            ('helpdesk', 'ticketdependency', ['add', 'view', 'change', 'delete']),
            ('helpdesk', 'ticketcc', ['add', 'view', 'change', 'delete']),
            ('helpdesk', 'ticketchange', ['add', 'view', 'change', 'delete']),
            ('helpdesk', 'ticketcustomfieldvalue', ['add', 'view', 'change', 'delete']),
            ('helpdesk', 'usersettings', ['add', 'view', 'change', 'delete']),
        ...
        'staff_1': [
            ...
            ('mainapp', 'category', ['add', 'view', 'change', 'delete']),
            ('helpdesk', 'checklisttask', ['view', 'change']),
            ('helpdesk', 'kbiattachment', ['add', 'view', 'change', 'delete']),
            ('helpdesk', 'followupattachment', ['add', 'view', 'change', 'delete']),
            ('helpdesk', 'ticket', ['add', 'view', 'change', 'delete']),
            ('helpdesk', 'ticketcc', ['add', 'view', 'change', 'delete']),
